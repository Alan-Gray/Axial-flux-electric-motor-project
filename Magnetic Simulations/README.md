...
I knew that stator cores and rotor backing iron would improve performance, but I didn't realise how much of an improvement it would be. Using stator cores more than doubles the magnetic field density, and rotor backing iron doubles it again. The simulations assume the magnetic material is iron which won't be the case for my motor (its way to expensive), but it is still clear that I should include both stator cores and backing iron in the motor.   
